...
interface DidYouMeanPlatformProps {
  platforms: PlatformInformation[];
  searchedName: string;
  onDismiss: () => void;
}

export const DidYouMeanPlatform: React.FC<DidYouMeanPlatformProps> = ({
  platforms,
  searchedName,
  onDismiss,
}) => {
  ...
  const handlePlatformClick = (platformName: string) => {
    // Navigate to the platform page or wherever platform details are shown
