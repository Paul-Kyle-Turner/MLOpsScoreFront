...
export const SupportTierForm: React.FC<SupportTierFormProps> = ({
  supportTiers,
  onChange,
}) => {
        ...
        >
          ...
          >
            <input
              ...
              value={tier.tierName}
              onChange={(e) =>
                updateSupportTier(index, "tierName", e.target.value)
              }
              style={{
                padding: "6px",
            ...
            <input
              ...
              onChange={(e) =>
                updateSupportTier(index, "averageResponseTime", e.target.value)
              }
              style={{
                padding: "6px",
                border: "1px solid #ccc",
            ...
            <input
              ...
              value={tier.price || ""}
              onChange={(e) =>
                updateSupportTier(index, "price", e.target.value)
              }
              style={{
                padding: "6px",
                border: "1px solid #ccc",
          ...
          <div style={{ marginBottom: "10px" }}>
            <input
              ...
              value={tier.hours}
              onChange={(e) =>
                updateSupportTier(index, "hours", e.target.value)
              }
              style={{
                width: "100%",
                padding: "6px",
