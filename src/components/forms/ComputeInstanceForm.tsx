...
export const ComputeInstanceForm: React.FC<ComputeInstanceFormProps> = ({
  instances,
  onChange,
}) => {
  const addInstance = () => {
  ...
  const addPricingModel = (instanceIndex: number) => {
    ...
    const updatedInstances = instances.map((instance, i) =>
      i === instanceIndex
        ? {
            ...instance,
            pricingModels: [...instance.pricingModels, newPricingModel],
          }
        : instance
    );
    onChange(updatedInstances);
  ...
  const removePricingModel = (instanceIndex: number, pricingIndex: number) => {
    const updatedInstances = instances.map((instance, i) =>
      i === instanceIndex
        ? {
            ...instance,
            pricingModels: instance.pricingModels.filter(
              (_, j) => j !== pricingIndex
            ),
          }
        : instance
        ...
        >
          ...
          >
            <input
              ...
              onChange={(e) =>
                updateInstance(instanceIndex, "instanceName", e.target.value)
              }
              style={{
                padding: "6px",
            ...
            <input
              ...
              onChange={(e) =>
                updateInstance(instanceIndex, "instanceFamily", e.target.value)
              }
              style={{
                padding: "6px",
                border: "1px solid #ccc",
            ...
            <input
              ...
              onChange={(e) =>
                updateInstance(instanceIndex, "architecture", e.target.value)
              }
              style={{
                padding: "6px",
                border: "1px solid #ccc",
          ...
          >
            ...
            <input
              ...
              onChange={(e) =>
                updateInstance(instanceIndex, "storageType", e.target.value)
              }
              style={{
                padding: "6px",
                border: "1px solid #ccc",
          ...
          >
            ...
            <input
              ...
              onChange={(e) =>
                updateInstance(instanceIndex, "gpuType", e.target.value)
              }
              style={{
                padding: "6px",
                border: "1px solid #ccc",
              ...
              >
                ...
                >
                  ...
                  <button
                    type="button"
                    onClick={() =>
                      removePricingModel(instanceIndex, pricingIndex)
                    }
                    style={{
                      padding: "3px 6px",
                ...
                >
                  ...
                  <select
                    value={
                      pricing.billingIncrement || BillingIncrement.PER_HOUR
                    }
                    onChange={(e) =>
                      updatePricingModel(
                        instanceIndex,
