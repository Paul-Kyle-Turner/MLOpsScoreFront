...
export const ProprietaryHardwareForm: React.FC<
  ProprietaryHardwareFormProps
> = ({ hardware, onChange }) => {
  const addHardware = () => {
  ...
  const updateHardware = (
    index: number,
    field: keyof ProprietaryHardware,
    value: unknown
  ) => {
        ...
        >
          ...
          >
            <input
              ...
              onChange={(e) =>
                updateHardware(index, "hardwareName", e.target.value)
              }
              style={{
                padding: "6px",
            ...
            <input
              ...
              onChange={(e) =>
                updateHardware(index, "hardwareType", e.target.value)
              }
              style={{
                padding: "6px",
                border: "1px solid #ccc",
            ...
            <input
              ...
              onChange={(e) =>
                updateHardware(index, "generation", e.target.value)
              }
              style={{
                padding: "6px",
                border: "1px solid #ccc",
          ...
          <div style={{ marginBottom: "10px" }}>
            <textarea
              ...
              onChange={(e) =>
                updateHardware(index, "description", e.target.value)
              }
              style={{
                width: "100%",
                padding: "6px",
          ...
          >
            <input
              ...
              onChange={(e) =>
                updateHardware(index, "availability", e.target.value)
              }
              style={{
                padding: "6px",
                border: "1px solid #ccc",
            ...
            <input
              ...
              onChange={(e) =>
                updateHardware(index, "manufacturingPartner", e.target.value)
              }
              style={{
                padding: "6px",
                border: "1px solid #ccc",
