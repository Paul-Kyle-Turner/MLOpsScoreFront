...
export const ProprietarySoftwareForm: React.FC<ProprietarySoftwareFormProps> = ({ software, onChange }) => {
  ...
  const updateSoftware = (index: number, field: keyof ProprietarySoftware, value: unknown) => {
        ...
        <div key={index} style={{ 
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '10px', marginBottom: '10px' }}>
            <input
              ...
              onChange={(e) => updateSoftware(index, 'softwareName', e.target.value)}
            ...
            <input
              ...
              onChange={(e) => updateSoftware(index, 'softwareType', e.target.value)}
              style={{ padding: '6px', border: '1px solid #ccc', borderRadius: '4px' }}
            />
            <input
              type="text"
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '10px', marginBottom: '10px' }}>
            <input
              ...
              onChange={(e) => updateSoftware(index, 'licenseType', e.target.value)}
              style={{ padding: '6px', border: '1px solid #ccc', borderRadius: '4px' }}
            />
            <input
              type="url"
              ...
              onChange={(e) => updateSoftware(index, 'documentationUrl', e.target.value)}
              style={{ padding: '6px', border: '1px solid #ccc', borderRadius: '4px' }}
            />
            <input
              type="url"
              ...
              onChange={(e) => updateSoftware(index, 'githubUrl', e.target.value)}
              style={{ padding: '6px', border: '1px solid #ccc', borderRadius: '4px' }}
            />
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr auto', gap: '10px', alignItems: 'center', marginBottom: '10px' }}>
            <textarea
              ...
              style={{ padding: '6px', border: '1px solid #ccc', borderRadius: '4px', minHeight: '40px' }}
            />
            <label style={{ display: 'flex', alignItems: 'center', gap: '5px', whiteSpace: 'nowrap' }}>
              <input
                type="checkbox"
                checked={item.openSource}
                onChange={(e) => updateSoftware(index, 'openSource', e.target.checked)}
              />
              Open Source
            </label>
          </div>
